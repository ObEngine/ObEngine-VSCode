...
---@class vili.parser.rules.block : peg.sor[vili.parser.rules.empty_line,vili.parser.rules.inline_comment,vili.parser.rules.multiline_comment_block,vili.parser.rules.template_decl,vili.parser.rules.full_node]
...
---@class vili.parser.rules.element : tao.pegtl.sor[vili.parser.rules.data,vili.parser.rules.array,vili.parser.rules.object,vili.parser.rules.template_usage]
...
---@class vili.parser.rules.inline_element : tao.pegtl.sor[vili.parser.rules.boolean,vili.parser.rules.number,vili.parser.rules.integer,vili.parser.rules.string,vili.parser.rules.array,vili.parser.rules.brace_based_object,vili.parser.rules.template_usage]
...
---@class vili.parser.rules.template_begin : tao.pegtl.seq[peg.bol,peg.star[vili.parser.rules.multiline_comment>,vili.parser.rules.template_keyword]]
vili.parser.rules._template_begin = {};



---@class vili.parser.rules.template_decl : peg.if_must[vili.parser.rules.template_begin,vili.parser.rules.template_decl_content]
vili.parser.rules._template_decl = {};



---@class vili.parser.rules.template_decl_content : tao.pegtl.seq[peg.blank,vili.parser.rules.template_identifier,peg.pad[peg.one[':'>,peg.blank>,vili.parser.rules.inline_element]]]
vili.parser.rules._template_decl_content = {};



---@class vili.parser.rules.template_identifier : tao.pegtl.identifier
vili.parser.rules._template_identifier = {};



---@class vili.parser.rules.template_identifier_usage : vili.parser.rules.template_identifier
vili.parser.rules._template_identifier_usage = {};



---@class vili.parser.rules.template_keyword : tao.pegtl.string['t','e','m','p','l','a','t','e']
vili.parser.rules._template_keyword = {};



---@class vili.parser.rules.template_specialization : tao.pegtl.sor[vili.parser.rules.array,vili.parser.rules.brace_based_object]
vili.parser.rules._template_specialization = {};



---@class vili.parser.rules.template_usage : tao.pegtl.seq[vili.parser.rules.template_identifier_usage,peg.opt[peg.seq[peg.star[peg.blank>,vili.parser.rules.template_specialization]]]]
