...
---@class vili.exceptions.unknown_template : vili.exceptions.exception[vili.exceptions.unknown_template]
...
function vili.exceptions.unknown_template(template_name, templates, info) end
